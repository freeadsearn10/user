...
async def ensure_database():
    ...
    try:
        ...
        # If we can't even connect to the server, log and return
        logger.error(f"Failed to connect to MySQL for database creation: {e}")
        return False
    ...
    try:
        ...
        logger.info(f"Ensured MySQL database '{MYSQL_DB}' exists")
        return True
    except Exception as e:
